...
def load_assets():
    ...
    # Using the exact lowercase filename you generated
...
try:
    ...
    st.error(f"Waiting for files... Please ensure 'upgraded_n_type_expert (4).pth' and 'polymer_lumo_scaler.pkl' are in your GitHub repo. System error: {e}")
    st.stop()
